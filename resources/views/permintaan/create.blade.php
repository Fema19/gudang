  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      select.addEventListener("change", function () {
        ...
        div.classList.add("d-flex", "align-items-center", "justify-content-between", "border", "p-2", "mb-2", "rounded");
      ...
      list.addEventListener("click", function (e) {
        if (e.target.classList.contains("plus-btn")) {
          ...
          if (list.querySelectorAll(".d-flex").length === 0) emptyText.style.display = "block";
        }
      });
    });
  </script>
